...
export function PublicShell({
  ...
  const registration: SiteModelRegistration =
    SITE_MODEL_REGISTRY[theme.siteModel];
  const ModelHeader = registration.Header;
  const ModelFooter = registration.Footer;
  ...
  return (
    ...
    >
      ...
      <VLibrasWidget />
      {ModelFooter ? (
        <ModelFooter categories={categories} tenant={tenant} theme={theme} />
      ) : (
